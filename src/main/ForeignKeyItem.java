...
public class ForeignKeyItem implements Comparable {
	...
	public ForeignKeyItem(Table pkTable, Column pkColumn, Table fkTable,
			Column fkColumn, String fkName, int seq) {
	...
	public String toString() {
		return "ForeignKeyItem [pkTable=" + pkTable.getName() + ", pkColumn="
				+ pkColumn + ", fkTable=" + fkTable.getName() + ", fkColumn="
				+ fkColumn + ", fkName=" + fkName + ", seq=" + seq + "]";
	}
